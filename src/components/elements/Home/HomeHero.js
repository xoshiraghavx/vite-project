                ...
                <div className='flex flex-row'>
                    <div className='w-3/5  pl-32 pt-[10vh]'>
                        <FollowerPointerCard
                            title={'Buy Now'}
                        >
                            <TextGenerateEffect words='#1 in Natural Hair Regrowth' className='text-base text-gray-600 font-normal mb-2' />
                            <div className='text-4xl md:text-6xl lg:text-7xl font-bold text-gray-800'>
                                Herbal Locks Hair Oil
                            </div>
                            <TextGenerateEffect words='Delays premature greying Keeps the scalp healthy Guranteed hair growth Nourishes the roots Hair loss control' className='mt-6 text-lg md:text-2xl font-medium text-gray-700' />
                            ...
                            {mounted ? <form id="payment-button" className='mt-6'></form> : null}

                        </FollowerPointerCard>
                    </div>
                    <div className='w-2/5'>
                        <img src="/assets/ill1.png" className='w-full mr-0 ml-auto' alt="" />
                    </div>
                </div>
            </div>
        </div>
